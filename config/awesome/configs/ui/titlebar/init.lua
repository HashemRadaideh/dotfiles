...
client.connect_signal("request::titlebars", function(c)
  ...
  local exit_button = wibox.widget({
    ...
    bg = (client.focus and c == client.focus) and beautiful.red or beautiful.taglist_fg_empty,
  ...
  exit_button:connect_signal("button::release", function()
    c:kill()
  end)
  ...
  local max_button = wibox.widget({
    forced_height = dpi(15),
    forced_width = dpi(15),
    bg = (client.focus and c == client.focus) and beautiful.green or beautiful.taglist_fg_empty,
    shape = function(cr, w, h)
      gears.shape.circle(cr, w, h)
    end,
    widget = wibox.container.background,
  ...
  local min_button = wibox.widget({
    forced_height = dpi(15),
    forced_width = dpi(15),
    bg = (client.focus and c == client.focus) and beautiful.blue or beautiful.taglist_fg_empty,
    shape = function(cr, w, h)
      gears.shape.circle(cr, w, h)
    end,
    widget = wibox.container.background,
  ...
  local floating_button = wibox.widget({
    forced_height = dpi(15),
    forced_width = dpi(15),
    bg = (client.focus and c == client.focus) and beautiful.magenta or beautiful.taglist_fg_empty,
    shape = function(cr, w, h)
      gears.shape.circle(cr, w, h)
    end,
    widget = wibox.container.background,
