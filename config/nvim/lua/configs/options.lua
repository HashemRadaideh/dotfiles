...
local settings = {
  ...
  opt = {
    ...
    updatetime = 250,                                -- If in this many milliseconds nothing is typed, the swap file will be written to disk. Also used for CursorHold autocommand
    history = 500,
    ...
    sessionoptions = { "buffers", "curdir", "tabpages", "folds", "winpos", "winsize" }, -- Session options to store in the session
    shada = "!,'0,f0,<50,s10,h",
    -- shell = "/bin/zsh",
  },
}
