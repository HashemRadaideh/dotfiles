return {
  ...
  -- },
  {
    ...
    keys = {
      ...
      { "<Leader><",     "<Cmd>MultipleCursorsJumpNextMatch<CR>",    mode = { "n", "x" } },
      { "<Leader>>",     "<Cmd>MultipleCursorsJumpPrevMatch<CR>",    mode = { "n", "x" } },
      { "<Leader>n",     "<Cmd>MultipleCursorsAddJumpNextMatch<CR>", mode = { "n", "x" } },
      { "<Leader>N",     "<Cmd>MultipleCursorsAddJumpPrevMatch<CR>", mode = { "n", "x" } },
      { "<Leader>all",   "<Cmd>MultipleCursorsAddMatches<CR>",       mode = { "n", "x" } },
      {
        "<Leader>M",
