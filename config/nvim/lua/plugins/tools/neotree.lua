...
vim.api.nvim_create_autocmd("ExitPre", {
  pattern = "*",
  group = vim.api.nvim_create_augroup("NeotreeOneVimExit", { clear = true }),
  once = true,
  callback = function(_)
...
return {
  ...
  opts = {
    ...
    git_status_async_options = {
      ...
      batch_delay = 100, -- delay in ms between batches. Spreads out the workload to let other processes run.
