...
if [[ -z "$TMUX" ]]; then # -n "$SSH_CONNECTION"
...
# This will be wrapped after starship loads (see starship.zsh)
...
# zle-line-init will be defined in starship.zsh or prompt.zsh
# This is just for vi mode cursor - will be merged with theme's zle-line-init
